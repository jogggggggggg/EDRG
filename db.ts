...
// Permet de distinguer « mot de passe faux » de « aucun mot de passe configuré sur Vercel »,
// pour ne pas laisser croire à un bug de saisie quand c'est en fait une variable manquante.
export function adminCodeConfigured(): boolean {
  return Boolean(process.env.ADMIN_ACCESS_CODE || process.env.ADMIN_PASSWORD)
}
